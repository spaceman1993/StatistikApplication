...
public class SpielerbildActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Button button 	= (Button) findViewById(R.id.fotowaehlen);
        mImageView		= (ImageView) findViewById(R.id.spielerbild);
